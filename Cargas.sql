...
VALUES (9, 'Friends', 'Tres hombres y tres mujeres jóvenes son mejores amigos y viven en el mismo conjunto de apartamentos.
...
INSERT INTO serie (id_serie, nombre, descripcion, genero, idioma, episodios, id_actor, id_productor, id_director)  
VALUES (17, 'Friends', 'Tres hombres y tres mujeres jóvenes son mejores amigos y viven en el mismo conjunto de apartamentos.
 Ellos enfrentan la vida y el amor en la ciudad de Nueva York y se involucran en los asuntos personales de los demás, 
 donde incluso a veces intercambian novios o novias, lo que algunas veces genera situaciones que las personas comunes
...
INSERT INTO serie (id_serie, nombre, descripcion, genero, idioma, episodios, id_actor, id_productor, id_director)  
VALUES (4, 'Game of Thrones', 'Es la descripción de dos familias poderosas, reyes y reinas, caballeros y renegados, hombres falsos y honestos, 
...
VALUES (1, 'Una esposa de mentira','2011-04-21', 'El cirujano Danny decide contratar a su ayudante Katherine, 
...
INSERT INTO pelicula (id_pelicula, nombre, año, descripcion, genero,idioma,id_actor,id_productor,id_director)  
VALUES (2, 'Una esposa de mentira','1999-09-23', 'Un irresponsable neoyorquino trata de darle estabilidad a su vida al 
adoptar a un niño rebelde de cinco años.','Comedia','Ingles',19 ,6 ,6);

INSERT INTO pelicula (id_pelicula, nombre, año, descripcion, genero,idioma,id_actor,id_productor,id_director)  
VALUES (3, 'Son Como Niños','2010-07-22', 'Un grupo de amigos y excompañeros descubren que envejecer no siempre significa madurar cuando se reúnen para honrar
 la memoria de su entrenador de baloncesto.','Comedia','Ingles',32 ,6, 6 );

INSERT INTO pelicula (id_pelicula, nombre, año, descripcion, genero,idioma,id_actor,id_productor,id_director)  
VALUES (4, 'Son Como Niños 2','2013-10-19', 'Tres años después de la reunión que volvió a unirlo a sus amigos de la infancia, Lenny Feder regresa junto a su familia a su pueblo natal para poder estar más cerca de sus amigos..','Comedia','Ingles',32 ,6, 6 );


INSERT INTO pelicula (id_pelicula, nombre, año, descripcion, genero,idioma,id_actor,id_productor,id_director)  
VALUES (5, 'Misterio a Bordo','2019-06-14', 'Un policía de Nueva York y su esposa se van de vacaciones a Europa para revitalizar
...
INSERT INTO pelicula (id_pelicula, nombre, año, descripcion, genero,idioma,id_actor,id_productor,id_director)  
VALUES (6, 'Marley y yo','2008-12-5', 'es una película estadounidense dirigida por David Frankel y protagonizada por Owen Wilson y Jennifer Aniston.
...
INSERT INTO serie (id_serie, nombre, descripcion, genero, idioma, episodios, id_actor, id_productor, id_director)  
VALUES (29, 'Homeland', 'Cuando el sargento del Cuerpo de Marines Nicholas Brody, que estuvo desaparecido en acción,
...
INSERT INTO pelicula (id_pelicula, nombre, año, descripcion, genero,idioma,id_actor,id_productor,id_director)  
VALUES (23, 'Misterio a Bordo','2019-06-14', 'Un policía de Nueva York y su esposa se van de vacaciones a Europa para revitalizar
...
INSERT INTO pelicula (id_pelicula, nombre, año, descripcion, genero,idioma,id_actor,id_productor,id_director)  
VALUES (10, 'Son Como Niños','2010-07-22', 'Un grupo de amigos y excompañeros descubren que envejecer no siempre significa madurar cuando se reúnen para honrar
 la memoria de su entrenador de baloncesto.','Comedia','Ingles',36 ,6, 6 );

INSERT INTO pelicula (id_pelicula, nombre, año, descripcion, genero,idioma,id_actor,id_productor,id_director)  
VALUES (14, 'Son Como Niños 2','2013-10-19', 'Tres años después de la reunión que volvió a unirlo a sus amigos de la infancia, Lenny Feder regresa junto a su familia 
a su pueblo natal para poder estar más cerca de sus amigos..','Comedia','Ingles',36 ,6, 6 );



INSERT INTO pelicula (id_pelicula, nombre, año, descripcion, genero,idioma,id_actor,id_productor,id_director)  
VALUES (18, 'Marley y yo','2008-12-5', 'es una película estadounidense dirigida por David Frankel y protagonizada por Owen Wilson y Jennifer Aniston.
 Perteneciente al género de comedia romántica y está basada en la novela autobiográfica del periodista John Grogan, Marley & Me.','Comedia Romántica',
 'Ingles', 40,8,8 );
